...
## Bug / Feature Request
If you find a bug (the website couldn't handle the query and/or gave undesired results), kindly open an issue [here](https://github.com/lioncoder8/productive-employment-prediction/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/lioncoder8/productive-employment-prediction/issues/new). Please include sample queries and their corresponding results.


## Authors

* **[Michael Song](https://github.com/lioncoder8)**
    

See also the list of [Contributors](https://github.com/lioncoder8/productive-employment-prediction/contri butors) who participated in this project.
